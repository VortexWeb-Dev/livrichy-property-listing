                    ...
                    <div class="row mt-3 p-3">
                        <div class="col-12 col-md-9 bg-light p-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" id="unitNo" name="unitNo" class="form-control" value="<?= $property['ufCrm13UnitNo']; ?>" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-6">
                        ...
                        <div class="col-12 col-md-3 bg-light p-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="<?= $property['ufCrm13ListingOwner']; ?>" id="listingOwner" name="listingOwner" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="landlordName">Landlord Name</label>
                                <input type="text" value="<?= $property['ufCrm13LandlordName']; ?>" id="landlordName" name="landlordName" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="landlordEmail">Landlord Email</label>
                                <input type="text" value="<?= $property['ufCrm13LandlordEmail']; ?>" id="landlordEmail" name="landlordEmail" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label for="landlordContact">Landlord Contact</label>
                                <input type="text" value="<?= $property['ufCrm13LandlordContact']; ?>" id="landlordContact" name="landlordContact" class="form-control">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" value="<?= $property['ufCrm13AvailableFrom']; ?>" id="availableFrom" name="availableFrom" class="form-control">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="tab-content mt-3" id="permitTabsContent">
                                <div class="tab-pane fade show active" id="rera" role="tabpanel">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" value="<?= $property['ufCrm13ReraPermitIssueDate'] ?>" id="reraPermitIssueDate" name="reraPermitIssueDate" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="reraPermitExpirationDate" class="form-label">RERA Permit Expiration Date</label>
                                        <input type="date" value="<?= $property['ufCrm13ReraPermitExpirationDate'] ?>" id="reraPermitExpirationDate" name="reraPermitExpirationDate" class="form-control">
                                    </div>
                                </div>
                    ...
                    <div class="container mt-5 p-3">
                        <div class="bg-light p-4 rounded border">
                            ...
                            <div id="photoPreview" class="text-center mb-3" style="display:none;">
                                <img id="selectedPhoto" src="<?= $property['ufCrm13_1726230114498'][0]['urlMachine'] ?>" class="img-fluid rounded" style="max-height: 300px;" alt="Selected Photo" />
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" value="<?= $property['ufCrm13VideoTourUrl'] ?>" id="videoUrl" name="videoUrl" class="form-control" placeholder="Enter video tour URL">
                                </div>
                                <div class="col-md-6 mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" value="<?= $property['ufCrm13QrCodePropertyBooster'] ?>" id="qrCode" name="qrCode" class="form-control" placeholder="Enter QR code URL">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row p-3 bg-light rounded border">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="<?= $property['ufCrm13PfLocation'] ?>" name="propertyLocation" id="propertyLocation" class="form-control">
                    ...
                    <div class="container mt-5 p-3">
                        <div class="bg-light p-4 rounded border">
                            ...
                            <div id="floorPlanPreview" class="text-center mb-3" style="display:none;">
                                <img src="<?= $property['ufCrm13FloorPlan'][0]['urlMachine'] ?>" id="selectedFloorPlan" class="img-fluid rounded" style="max-height: 300px;" alt="Selected Floor Plan" />
                            </div>
