...
<script>
    ...
    async function updateItem(entityTypeId, fields, id) {
        try {
            const response = await fetch(`https://crm.livrichy.com/rest/1509/o8fnjtg7tyf787h4/crm.item.update?entityTypeId=${entityTypeId}&id=${id}`, {
                method: 'POST',
                headers: {
    ...
    async function handleEditProperty(e) {
        ...
        const fields = {
            ...
            "ufCrm13City": data.bayut_city,
            "ufCrm13Community": data.bayut_community,
            "ufCrm13SubCommunity": data.bayut_subcommunity,
        ...
        if (agent) {
            Object.assign(fields, {
                "ufCrm13AgentId": agent.ufCrm14AgentId,
                "ufCrm13AgentName": agent.ufCrm14AgentName,
                "ufCrm13AgentEmail": agent.ufCrm14AgentEmail,
                "ufCrm13AgentPhone": agent.ufCrm14AgentMobile,
                "ufCrm13AgentPhoto": agent.ufCrm14AgentPhoto,
                "ufCrm13AgentLicense": agent.ufCrm14AgentLicense,
            });
        }
        ...
        if (existingPhotosString) {
            ...
            if (photos.length > 0) {
                ...
                fields["ufCrm13PhotoLinks"] = [...existingPhotos];
            }
        }
        ...
        if (existingFloorplansString || floorplans.length > 0) {
            ...
            if (floorplans.length > 0) {
                ...
                fields["ufCrm13FloorPlan"] = uploadedFloorplans.length > 0 ?
                    uploadedFloorplans[0] :
                    existingFloorplans[0] || null;
            } else {

                fields["ufCrm13FloorPlan"] = existingFloorplans[0] || null;
            }
        } else {
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        const containers = [{
                ...
                newLinks: [],
                selectedFiles: [],
                existingLinks: property['ufCrm13PhotoLinks'] || [],
