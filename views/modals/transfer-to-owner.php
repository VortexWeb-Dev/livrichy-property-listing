...
<script>
    ...
    async function getOwner(ownerId) {
        const response = await fetch(`https://crm.livrichy.com/rest/1509/o8fnjtg7tyf787h4/crm.item.list?entityTypeId=1050&filter[ufCrm14OwnerId]=${ownerId}`);
    ...
    async function handleTransferOwnerSubmit(e) {
        ...
        const fields = {
            "ufCrm13ListingOwner": formData.get('listing_owner'),
        };
