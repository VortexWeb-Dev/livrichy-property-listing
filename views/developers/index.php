...
<script>
    ...
    async function fetchDevelopers(page = 1) {
        ...
        const apiUrl = `${baseUrl}/crm.item.list?entityTypeId=${entityTypeId}&order[id]=desc&select[0]=id&select[1]=ufCrm18DeveloperName&start=${(page - 1) * pageSize}`;
        ...
        try {
            ...
            developerList.innerHTML = developers
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">${developer.ufCrm18DeveloperName || 'N/A'}</td>
    ...
    async function deleteDeveloper(developerId) {
        const baseUrl = 'https://crm.livrichy.com/rest/1509/o8fnjtg7tyf787h4';
        const apiUrl = `${baseUrl}/crm.item.delete?entityTypeId=1066&id=${developerId}`;
