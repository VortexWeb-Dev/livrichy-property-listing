...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const url = 'https://crm.livrichy.com/rest/1509/o8fnjtg7tyf787h4/crm.item.list?entityTypeId=1066&select[0]=ID&select[1]=ufCrm18DeveloperName&order[ufCrm18DeveloperName]=asc';
        ...
        const fetchAndDisplayOptions = async () => {
            try {
                ...
                developers.forEach(developer => {
                    ...
                    option.value = developer.ufCrm18DeveloperName;
                    option.textContent = developer.ufCrm18DeveloperName;
