<div class="bg-white shadow-md rounded-lg p-6">
    ...
    <div class="grid grid-cols-1 gap-6 my-4">
        ...
        <!-- Column 1 -->
        <div>
            <label for="title_web" class="block text-sm font-medium mb-2">Title (Website) <span class="text-danger">*</span></label>
            <input type="text" id="title_web" name="title_web" maxlength="50" oninput="updateCharCount('titleWebCount', this.value.length, 50);" lang="en" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" required>
            <small class="text-xs text-gray-500"><span id="titleWebCount">0</span> / 50 characters</small>
        </div>

        <!-- Column 1 -->
        <div>
            <label for="description_web" class="block text-sm font-medium mb-2">Description (Website) <span class="text-danger">*</span></label>
            <textarea id="description_web" name="description_web" maxlength="1500" oninput="updateCharCount('descriptionWebCount', this.value.length, 1500);" lang="en" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" required rows="15"></textarea>
