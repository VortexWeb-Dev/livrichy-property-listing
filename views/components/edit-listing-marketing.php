<div class="text-center mb-3">
    ...
    <label for="marketing" class="dropzone p-4 d-block">
...
<input type="hidden" id="existingMarketing" name="existingMarketing" />

<label class="block text-sm font-medium mb-2">New Marketing Image</label>
<div id="newMarketingPreviewContainer" class="marketingPreviewContainer mb-4">
</div>

<label class="block text-sm font-medium mb-2">Existing Marketing Image</label>
<div id="existingMarketingPreviewContainer" class="marketingPreviewContainer mb-4">
</div>