...
<script>
    ...
    async function fetchLocations(page = 1) {
        ...
        const apiUrl = `${baseUrl}/crm.item.list?entityTypeId=${entityTypeId}&order[id]=desc&select[0]=id&select[1]=ufCrm16Location&start=${(page - 1) * pageSize}`;
        ...
        try {
            ...
            locationList.innerHTML = locations
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">${location.ufCrm16Location || 'N/A'}</td>
    ...
    async function deleteLocation(locationId) {
        const baseUrl = 'https://crm.livrichy.com/rest/1509/o8fnjtg7tyf787h4';
        const apiUrl = `${baseUrl}/crm.item.delete?entityTypeId=1058&id=${locationId}`;
