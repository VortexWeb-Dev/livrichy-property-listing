                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-header d-flex flex-column">
                                    ...
                                    <p class="text-small text-muted"><?php echo $property['ufCrm13LandlordName'] ?></p>
                                </div>
                                <div class="card-body">
                                    ...
                                    <table class="table table-sm">
                                        <tr>
                                            ...
                                            <td><?php echo isset($property['ufCrm13ReferenceNumber']) ? $property['ufCrm13ReferenceNumber'] : 'Unavailable'; ?></td>
                                        </tr>
                                    ...
                                    <table class="table table-sm">
                                        <tr>
                                            ...
                                            <td><?php echo $property['ufCrm13FinancialStatus'] ?></td>
                                        </tr>
                                        <tr>
                                            <td>Available From:</td>
                                            <td><?php echo $property['ufCrm13AvailableFrom'] ?></td>
                                        </tr>
                                    </table> -->
                                </div>
                            </div>
                        ...
                        <div class="carousel">
                            ...
                            <?php for ($i = 0; $i < count($property['ufCrm13PhotoLinks']); $i++) { ?>
                                <div class="carousel-item">
                                    <img src="<?= htmlspecialchars($property['ufCrm13PhotoLinks'][$i]) ?>" alt="image - .<?= $i + 1 ?>" data-src="<?= htmlspecialchars($property['ufCrmPhotoLinks'][$i]) ?>" class="thumbnail">
                                </div>
                            <?php } ?>
                        </div>
